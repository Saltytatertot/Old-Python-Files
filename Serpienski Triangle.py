import turtle
def drawTriangle(left_x, left_y, top_x, top_y, right_x,
    right_y,color,myTurtle):
...
def sierpinski(left_x, left_y, top_x, top_y, right_x, right_y, degree,
    myTurtle):

    colormap = ['blue','red','green','white','yellow','violet','orange']
    drawTriangle(left_x, left_y, top_x, top_y, right_x, right_y,
    colormap[degree], myTurtle)
...
def main():
    ...
    sierpinski(-100, -50, 0, 100, 100, -50, 3, myTurtle)
    myWin.exitonclick()
main()
